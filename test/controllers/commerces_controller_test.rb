...
class CommercesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commerce" do
    assert_difference("Commerce.count") do
      post commerces_url, params: { commerce: { address: @commerce.address, city: @commerce.city, name: @commerce.name, postal_code: @commerce.postal_code, state: @commerce.state, user_id: @commerce.user_id } }
    end
  ...
  test "should update commerce" do
    patch commerce_url(@commerce), params: { commerce: { address: @commerce.address, city: @commerce.city, name: @commerce.name, postal_code: @commerce.postal_code, state: @commerce.state, user_id: @commerce.user_id } }
