class ProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to product_url(@product), notice: "El producto se registro exitosamente" }
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to product_url(@product), notice: "El producto se actualizo exitosamente" }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :discount, :user_id, :brand, :quantity, :model, :category_id, photos: [])
    end
end
